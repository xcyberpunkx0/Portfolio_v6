      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-3 mt-10">
          ...
          <div className="flex items-center gap-3">
            <a href="https://www.linkedin.com/in/aditya-gup1a/" target="_blank" className="w-9 h-9 flex items-center justify-center bg-[#111111] border border-zinc-800/80 text-zinc-400 hover:text-white hover:bg-[#1A1A1A] rounded-lg transition-all" aria-label="LinkedIn">
